...
function toastrWelcome($scope, toastr) {
    toastr.info('Bootstrap 4 Admin Template', 'Welcome to Genius Admin', {
        closeButton: true,
        progressBar: true,
    });
}
...
function mainChartCtrl($scope){
    ...
    $scope.labels = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday'];
    $scope.series = ['Current', 'Previous', 'BEP'];
    $scope.data = [ data1, data2, data2];
    $scope.colors = [{
        type: 'line',
